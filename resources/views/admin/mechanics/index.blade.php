            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Mechanic Detail</h4>
                    </div>
        ...
        function del(id) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    window.location.href = APP_URL + "/admin/mechanic/delete/" + id;
                }
            });
        }

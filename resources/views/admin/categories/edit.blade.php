        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            ...
            <div class="card-toolbar">
              ...
              <div class="btn-group">
                <a href=""  onclick="event.preventDefault(); document.getElementById('category_update_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
          ...
          <!--begin::Form-->
            {{ Form::model($category, [ 'method' => 'PATCH','route' => ['categories.update', $category->id],'class'=>'form' ,"id"=>"category_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
                         ...
                         <div class="col-9">
                            <select class="form-control form-control-solid" name="parent_id" required>
                                ...
                                @foreach ($categories as $cat)
                                     <option value="{{$cat->id}}"  {{ $cat->id == $category->parent_id ? 'selected' : '' }}>{{$category->title}}</option>
                                @endforeach

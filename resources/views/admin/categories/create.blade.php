        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            ...
            <div class="card-toolbar">
              ...
              <div class="btn-group">
                <a href="{{ route('categories.store') }}"  onclick="event.preventDefault(); document.getElementById('category_add_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">

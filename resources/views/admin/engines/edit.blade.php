          ...
          <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
              <li class="breadcrumb-item text-muted">
                <a href="" class="text-muted">Manage Engine Capacity</a>
              </li>
              <li class="breadcrumb-item text-muted">
        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">Engine Capacity Edit Form
                <i class="mr-2"></i>
            ...
            <div class="card-toolbar">
              ...
              <div class="btn-group">
                <a href=""  onclick="event.preventDefault(); document.getElementById('engines_update_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
          ...
          <!--begin::Form-->
            {{ Form::model($fuel, [ 'method' => 'PATCH','route' => ['engines.update', $fuel->id],'class'=>'form' ,"id"=>"engines_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
                       ...
                       <label class="col-3">Models</label>
                        ...
                        <select class="form-control form-control-solid" name="model" required>
                            ...
                            @foreach ($models as $model)
                                    <option value="{{$model->id}}" {{ $model->id == $fuel->model_id ? 'selected' : '' }}>{{$model->title}}</option>
                            @endforeach  
                        </select>

        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">Make Edit Form
                <i class="mr-2"></i>
            ...
            <div class="card-toolbar">
              ...
              <div class="btn-group">
                <a href=""  onclick="event.preventDefault(); document.getElementById('make_update_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
          ...
          <!--begin::Form-->
            {{ Form::model($make, [ 'method' => 'PATCH','route' => ['makes.update', $make->id],'class'=>'form' ,"id"=>"make_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">

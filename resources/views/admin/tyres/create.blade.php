        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">Tyre Add Form
                <i class="mr-2"></i>
            ...
            <div class="card-toolbar">
              ...
              <div class="btn-group">
                <a href="{{ route('tyres.store') }}"  onclick="event.preventDefault(); document.getElementById('tyre_add_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
          ...
          <!--begin::Form-->
            {{ Form::open([ 'route' => 'tyres.store','class'=>'form' ,"id"=>"tyre_add_form", 'enctype'=>'multipart/form-data']) }}
              @csrf
              <div class="row">
                        ...
                        <label class="col-3">Service Category</label>
                         <div class="col-9">
                            <select class="form-control form-control-solid" name="type" required>
                                ...
                                <option value="Rear & Front">Rear & Front</option>
